...
class ImageToPDFConverter:
    ...
    def initialize_ui(self):
        ...
        convert_button = tk.Button(self.root, text="Convert To PDF", command=self.convert_image_pdf)
    ...
    def convert_image_pdf(self):
        ...
        output_pdf_path = filedialog.asksaveasfilename(
            ...
            initialfile=self.output_pdf_name.get() if self.output_pdf_name.get() else "output.pdf",
            title="Save PDF As"
        )
        ...
        pdf.save()
        messagebox.showinfo("Conversion Complete", f"PDF successfully saved at:\n{output_pdf_path}")
